    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            children: [
              CustomAppBarRowWithCustomIconWithNoSpacing(title: "Privacy Policy",),
              SizedBox(height: 30,),
