import 'package:buds_driver_app/views/add_info/add_vehicle.dart';
...
import 'package:buds_driver_app/controllers/authentication/otp_controller.dart';
import 'package:buds_driver_app/widgets/full_width_button.dart';
import 'package:buds_driver_app/widgets/otp_text_field.dart';
                  ...
                  FullWidthButton(
                    ...
                    onTap: (){
                        if(_globalKey1.currentState.validate()){
                          Navigator.push(context, MaterialPageRoute(builder: (context){return AddVehicleView();}));
                        }
                    },
                  )
